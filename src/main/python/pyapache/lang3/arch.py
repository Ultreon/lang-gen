...
_Enum = _Enum
import org.apache.commons.lang3.arch.Processor as _Processor_Type
_Type = _Processor_Type.Type
...
class Type():
    ...
    def getLabel(self) -> str:
        ...
        return str._wrap(super(Type, self).getLabel())
...
import java.util.Optional as Optional
from builtins import bool
import org.apache.commons.lang3.arch.Processor as _Processor_Arch
_Arch = _Processor_Arch.Arch
import java.lang.Long as _long
from builtins import int
import java.lang.Class as _Class
_Class = _Class
...
class Arch():
    ...
    @staticmethod
    def _wrap(java_value: _Arch) -> 'Arch':
    ...
    #
    @overload
    def __init__(self, __dynamic__: _Arch):
        """
    ...
    def valueOf(arg0: str) -> 'Arch':
        ...
        return Arch._wrap(_Arch.valueOf(arg0))
    ...
    def getLabel(self) -> str:
        ...
        return str._wrap(super(Arch, self).getLabel())
    ...
    def values() -> List['Arch']:
        ...
        return List[Arch]._wrap(_Arch.values()) 
...
class Processor():
    ...
    @staticmethod
    def _wrap(java_value: _Processor) -> 'Processor':
    ...
    #
    @overload
    def __init__(self, __dynamic__: _Processor):
        """
    ...
    def isX86(self) -> bool:
        ...
        return bool._wrap(super(Processor, self).isX86())
    ...
    def toString(self) -> str:
        ...
        return str._wrap(super(Processor, self).toString())
    ...
    def isIA64(self) -> bool:
        ...
        return bool._wrap(super(Processor, self).isIA64())
