...
import com.google.common.base.internal.Finalizer as _Finalizer
...
class Finalizer():
    ...
    @staticmethod
    def _wrap(java_value: _Finalizer) -> 'Finalizer':
    ...
    #
    @overload
    def __init__(self, __dynamic__: _Finalizer):
        """
    ...
    def startFinalizer(finalizableReferenceClass: 'Class', queue: 'ReferenceQueue', frqReference: 'PhantomReference'):
        ...
        _Finalizer.startFinalizer(finalizableReferenceClass, queue, frqReference)
