...
import java.lang.Object as __Object
__Object = __Object
import com.google.common.xml.XmlEscapers as __XmlEscapers
__XmlEscapers = __XmlEscapers
...
class XmlEscapers():
    ...
    @staticmethod
    def __wrap(java_value: __XmlEscapers) -> 'XmlEscapers':
    ...
    #
    @overload
    def __init__(self, __dynamic__: __XmlEscapers):
        """
    ...
    def xmlContentEscaper() -> 'escape.Escaper':
        ...
        return escape.Escaper.__wrap(__XmlEscapers.xmlContentEscaper())
    ...
    def xmlAttributeEscaper() -> 'escape.Escaper':
        ...
        return escape.Escaper.__wrap(__XmlEscapers.xmlAttributeEscaper())
