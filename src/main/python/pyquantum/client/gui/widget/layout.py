...
_String = _String
import dev.ultreon.quantum.client.gui.widget.layout.StandardLayout as _StandardLayout
_StandardLayout = _StandardLayout
...
class StandardLayout():
    ...
    @staticmethod
    def _wrap(java_value: _StandardLayout) -> 'StandardLayout':
    ...
    #
    @overload
    def __init__(self, __dynamic__: _StandardLayout):
        """
    ...
    def __getattr__(self, name: str):
        ...
        if name == "_StandardLayout__wrapper":
    ...
    def relayout(self, arg0: 'UIContainer'):
        ...
        super(_StandardLayout, self).relayout(arg0)
