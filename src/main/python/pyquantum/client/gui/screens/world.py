...
import java.lang.String as __String
__String = __String
import dev.ultreon.quantum.client.gui.screens.world.WorldSelectionScreen as __WorldSelectionScreen
__WorldSelectionScreen = __WorldSelectionScreen
import java.lang.Object as __Object
__Object = __Object
...
class WorldSelectionScreen():
    ...
    @staticmethod
    def __wrap(java_value: __WorldSelectionScreen) -> 'WorldSelectionScreen':
    ...
    #
    @overload
    def __init__(self, __dynamic__: __WorldSelectionScreen):
        """
    ...
    def locateWorlds(self) -> 'List':
        ...
        return 'List'.__wrap(super(WorldSelectionScreen, self).locateWorlds())
    ...
    def getDeleteWorld(self) -> 'widget.TextButton':
        ...
        return 'widget.TextButton'.__wrap(super(WorldSelectionScreen, self).getDeleteWorld())

    @overload
    def __init__(self):
        """public dev.ultreon.quantum.client.gui.screens.world.WorldSelectionScreen()"""
        val = __WorldSelectionScreen()
    ...
    def getPlayButton(self) -> 'widget.TextButton':
        ...
        return 'widget.TextButton'.__wrap(super(WorldSelectionScreen, self).getPlayButton())
    ...
    def getSelected(self) -> 'world.WorldStorage':
        ...
        return 'world.WorldStorage'.__wrap(super(WorldSelectionScreen, self).getSelected())
    ...
    def getCreateButton(self) -> 'widget.TextButton':
        ...
        return 'widget.TextButton'.__wrap(super(WorldSelectionScreen, self).getCreateButton())
    ...
    def getWorldList(self) -> 'widget.WorldCardList':
        ...
        return 'widget.WorldCardList'.__wrap(super(WorldSelectionScreen, self).getWorldList())
    ...
    def build(self, arg0: 'GuiBuilder'):
        ...
        super(__WorldSelectionScreen, self).build(arg0)
