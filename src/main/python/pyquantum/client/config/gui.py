...
import dev.ultreon.quantum.client.config.gui.CraftyConfigGui as _CraftyConfigGui
_CraftyConfigGui = _CraftyConfigGui
...
class CraftyConfigGui():
    ...
    @staticmethod
    def _wrap(java_value: _CraftyConfigGui) -> 'CraftyConfigGui':
    ...
    #
    @overload
    def __init__(self, __dynamic__: _CraftyConfigGui):
        """
    ...
    def __getattr__(self, name: str):
        ...
        if name == "_CraftyConfigGui__wrapper":
    ...
    def build(self, arg0: 'GuiBuilder'):
        ...
        super(_CraftyConfigGui, self).build(arg0)
...
class ConfigEntry():
    ...
    def get(self) -> object:
        ...
        return object._wrap(super(ConfigEntry, self).get())

    @overload
    def getDescription(self) -> str:
        """public java.lang.String dev.ultreon.quantum.client.config.gui.ConfigEntry.getDescription()"""
        return str._wrap(super(ConfigEntry, self).getDescription())
    ...
    def getKey(self) -> str:
        ...
        return str._wrap(super(ConfigEntry, self).getKey())
    ...
    def comment(self, arg0: str) -> 'ConfigEntry':
        ...
        return 'ConfigEntry'._wrap(super(_ConfigEntry, self).comment(arg0))

    @overload
    def set(self, arg0: object):
        """public void dev.ultreon.quantum.client.config.gui.ConfigEntry.set(T)"""
        super(_ConfigEntry, self).set(arg0)
