...
import dev.ultreon.quantum.server.dedicated.gui.DedicatedServerGui as __DedicatedServerGui
__DedicatedServerGui = __DedicatedServerGui
...
class DedicatedServerGui():
    ...
    @staticmethod
    def __wrap(java_value: __DedicatedServerGui) -> 'DedicatedServerGui':
        return DedicatedServerGui(__dynamic__=java_value)
 
    #
    # DO NOT USE THIS. THIS IS FOR THE JAVA WRAPPER ONLY!
    #
    @overload
    def __init__(self, __dynamic__: __DedicatedServerGui):
        """
        Dynamic initializer for DedicatedServerGui.
    ...
    @overload
    def __init__(self):
        """public dev.ultreon.quantum.server.dedicated.gui.DedicatedServerGui() throws java.awt.HeadlessException"""
        val = __DedicatedServerGui()
...
# CLASS: dev.ultreon.quantum.server.dedicated.gui.DedicatedServerGui
import javax.accessibility.AccessibleContext as AccessibleContext
import java.awt.im.InputMethodRequests as __InputMethodRequests
__InputMethodRequests = __InputMethodRequests
import java.awt.event.HierarchyBoundsListener as HierarchyBoundsListener
...
# CLASS: dev.ultreon.quantum.server.dedicated.gui.ServerLogGui
import javax.accessibility.AccessibleContext as AccessibleContext
import javax.swing.JToolTip as JToolTip
import java.awt.im.InputMethodRequests as __InputMethodRequests
__InputMethodRequests = __InputMethodRequests
import java.awt.event.HierarchyBoundsListener as HierarchyBoundsListener
import javax.swing.JScrollBar as __JScrollBar
__JScrollBar = __JScrollBar
...
from builtins import int
import java.awt.LayoutManager as LayoutManager
import javax.swing.JScrollBar as JScrollBar
import java.awt.Container as Container
from builtins import type
import java.awt.Rectangle as __Rectangle
__Rectangle = __Rectangle
...
import java.util.EventListener as EventListener
import java.lang.Short as __short
import javax.swing.JScrollPane as __JScrollPane
__JScrollPane = __JScrollPane
import java.awt.Insets as Insets
import java.awt.Font as __Font
__Font = __Font
import java.awt.event.ComponentListener as __ComponentListener
...
import java.io.PrintWriter as PrintWriter
import java.awt.Point as Point
import javax.swing.JViewport as JViewport
import javax.swing.JViewport as __JViewport
__JViewport = __JViewport
import java.awt.Color as __Color
__Color = __Color
import java.awt.event.KeyListener as __KeyListener
__KeyListener = __KeyListener
...
import javax.swing.plaf.ScrollPaneUI as __ScrollPaneUI
__ScrollPaneUI = __ScrollPaneUI
import javax.swing.JRootPane as JRootPane
import java.awt.Event as Event
import java.awt.event.FocusListener as FocusListener
...
import java.awt.ComponentOrientation as __ComponentOrientation
__ComponentOrientation = __ComponentOrientation
import dev.ultreon.quantum.server.dedicated.gui.ServerLogGui as __ServerLogGui
__ServerLogGui = __ServerLogGui
import java.awt.event.ContainerListener as __ContainerListener
__ContainerListener = __ContainerListener
import java.awt.FocusTraversalPolicy as FocusTraversalPolicy
...
import java.lang.Long as __long
import java.util.Set as Set
import javax.swing.plaf.ScrollPaneUI as ScrollPaneUI
import java.awt.Container as __Container
__Container = __Container
import java.awt.FontMetrics as FontMetrics
import java.awt.Color as Color
...
class ServerLogGui():
    ...
    @staticmethod
    def __wrap(java_value: __ServerLogGui) -> 'ServerLogGui':
        return ServerLogGui(__dynamic__=java_value)
 
    #
    # DO NOT USE THIS. THIS IS FOR THE JAVA WRAPPER ONLY!
    #
    @overload
    def __init__(self, __dynamic__: __ServerLogGui):
        """
        Dynamic initializer for ServerLogGui.
        WARNING: DO NOT USE THIS. THIS IS FOR THE JAVA WRAPPER ONLY!
    ...
    def getUIClassID(self) -> str:
        ...
        return str.__wrap(super(JScrollPane, self).getUIClassID())
    ...
    @override
    @overload
    def getVerticalScrollBarPolicy(self) -> int:
        """public int javax.swing.JScrollPane.getVerticalScrollBarPolicy()"""
        return int.__wrap(super(JScrollPane, self).getVerticalScrollBarPolicy())
    ...
    @override
    @overload
    def setHorizontalScrollBar(self, arg0: 'JScrollBar'):
        """public void javax.swing.JScrollPane.setHorizontalScrollBar(javax.swing.JScrollBar)"""
        super(__JScrollPane, self).setHorizontalScrollBar(arg0)
    ...
    @override
    @overload
    def createVerticalScrollBar(self) -> 'JScrollBar':
        """public javax.swing.JScrollBar javax.swing.JScrollPane.createVerticalScrollBar()"""
        return 'JScrollBar'.__wrap(super(JScrollPane, self).createVerticalScrollBar())
    ...
    @override
    @overload
    def getColumnHeader(self) -> 'JViewport':
        """public javax.swing.JViewport javax.swing.JScrollPane.getColumnHeader()"""
        return 'JViewport'.__wrap(super(JScrollPane, self).getColumnHeader())
    ...
    @overload
    def clear(self):
        """public void dev.ultreon.quantum.server.dedicated.gui.ServerLogGui.clear()"""
        super(ServerLogGui, self).clear()

    @overload
    def __init__(self, ):
        """public dev.ultreon.quantum.server.dedicated.gui.ServerLogGui()"""
        val = __ServerLogGui()
        self.__dict__ = val.__dict__
        self.__wrapper = val
    ...
    @override
    @overload
    def setVerticalScrollBarPolicy(self, arg0: int):
        """public void javax.swing.JScrollPane.setVerticalScrollBarPolicy(int)"""
        super(__JScrollPane, self).setVerticalScrollBarPolicy(__int.valueOf(arg0))

    @override
    @overload
    def getVerticalScrollBar(self) -> 'JScrollBar':
        """public javax.swing.JScrollBar javax.swing.JScrollPane.getVerticalScrollBar()"""
        return 'JScrollBar'.__wrap(super(JScrollPane, self).getVerticalScrollBar())
    ...
    def getAccessibleContext(self) -> 'AccessibleContext':
        ...
        return 'AccessibleContext'.__wrap(super(JScrollPane, self).getAccessibleContext())
    ...
    @override
    @overload
    def setViewport(self, arg0: 'JViewport'):
        """public void javax.swing.JScrollPane.setViewport(javax.swing.JViewport)"""
        super(__JScrollPane, self).setViewport(arg0)
    ...
    def updateUI(self):
        ...
        super(JScrollPane, self).updateUI()
    ...
    @override
    @overload
    def setRowHeaderView(self, arg0: 'Component'):
        """public void javax.swing.JScrollPane.setRowHeaderView(java.awt.Component)"""
        super(__JScrollPane, self).setRowHeaderView(arg0)
    ...
    def setLayout(self, arg0: 'LayoutManager'):
        ...
        super(__JScrollPane, self).setLayout(arg0)
    ...
    def isValidateRoot(self) -> bool:
        ...
        return bool.__wrap(super(JScrollPane, self).isValidateRoot())
    ...
    @override
    @overload
    def getHorizontalScrollBar(self) -> 'JScrollBar':
        """public javax.swing.JScrollBar javax.swing.JScrollPane.getHorizontalScrollBar()"""
        return 'JScrollBar'.__wrap(super(JScrollPane, self).getHorizontalScrollBar())
    ...
    def scrollToTop(self):
        """public void dev.ultreon.quantum.server.dedicated.gui.ServerLogGui.scrollToTop()"""
        super(ServerLogGui, self).scrollToTop()
    ...
    @override
    @overload
    def setHorizontalScrollBarPolicy(self, arg0: int):
        """public void javax.swing.JScrollPane.setHorizontalScrollBarPolicy(int)"""
        super(__JScrollPane, self).setHorizontalScrollBarPolicy(__int.valueOf(arg0))
    ...
    @override
    @overload
    def setViewportView(self, arg0: 'Component'):
        """public void javax.swing.JScrollPane.setViewportView(java.awt.Component)"""
        super(__JScrollPane, self).setViewportView(arg0)
    ...
    def setComponentOrientation(self, arg0: 'ComponentOrientation'):
        ...
        super(__JScrollPane, self).setComponentOrientation(arg0)
    ...
    @override
    @overload
    def getViewportBorderBounds(self) -> 'Rectangle':
        """public java.awt.Rectangle javax.swing.JScrollPane.getViewportBorderBounds()"""
        return 'Rectangle'.__wrap(super(JScrollPane, self).getViewportBorderBounds())

    @override
    @overload
    def setVerticalScrollBar(self, arg0: 'JScrollBar'):
        """public void javax.swing.JScrollPane.setVerticalScrollBar(javax.swing.JScrollBar)"""
        super(__JScrollPane, self).setVerticalScrollBar(arg0)
    ...
    @overload
    def getCorner(self, arg0: str) -> 'Component':
        """public java.awt.Component javax.swing.JScrollPane.getCorner(java.lang.String)"""
        return 'Component'.__wrap(super(__JScrollPane, self).getCorner(arg0))
    ...
    def isWheelScrollingEnabled(self) -> bool:
        ...
        return bool.__wrap(super(JScrollPane, self).isWheelScrollingEnabled())
    ...
    @override
    @overload
    def setColumnHeaderView(self, arg0: 'Component'):
        """public void javax.swing.JScrollPane.setColumnHeaderView(java.awt.Component)"""
        super(__JScrollPane, self).setColumnHeaderView(arg0)
    ...
    @override
    @overload
    def getRowHeader(self) -> 'JViewport':
        """public javax.swing.JViewport javax.swing.JScrollPane.getRowHeader()"""
        return 'JViewport'.__wrap(super(JScrollPane, self).getRowHeader())
    ...
    @override
    @overload
    def createHorizontalScrollBar(self) -> 'JScrollBar':
        """public javax.swing.JScrollBar javax.swing.JScrollPane.createHorizontalScrollBar()"""
        return 'JScrollBar'.__wrap(super(JScrollPane, self).createHorizontalScrollBar())

    @override
    @overload
    def setViewportBorder(self, arg0: 'Border'):
        """public void javax.swing.JScrollPane.setViewportBorder(javax.swing.border.Border)"""
        super(__JScrollPane, self).setViewportBorder(arg0)
    ...
    @override
    @overload
    def setCorner(self, arg0: str, arg1: 'Component'):
        """public void javax.swing.JScrollPane.setCorner(java.lang.String,java.awt.Component)"""
        super(__JScrollPane, self).setCorner(arg0, arg1)
    ...
    def scrollToBottom(self):
        """public void dev.ultreon.quantum.server.dedicated.gui.ServerLogGui.scrollToBottom()"""
        super(ServerLogGui, self).scrollToBottom()
    ...
    @override
    @overload
    def getViewport(self) -> 'JViewport':
        """public javax.swing.JViewport javax.swing.JScrollPane.getViewport()"""
        return 'JViewport'.__wrap(super(JScrollPane, self).getViewport())
    ...
    @override
    @overload
    def setColumnHeader(self, arg0: 'JViewport'):
        """public void javax.swing.JScrollPane.setColumnHeader(javax.swing.JViewport)"""
        super(__JScrollPane, self).setColumnHeader(arg0)

    @override
    @overload
    def getViewportBorder(self) -> 'Border':
        """public javax.swing.border.Border javax.swing.JScrollPane.getViewportBorder()"""
        return 'Border'.__wrap(super(JScrollPane, self).getViewportBorder())
    ...
    @override
    @overload
    def getUI(self) -> 'ScrollPaneUI':
        """public javax.swing.plaf.ScrollPaneUI javax.swing.JScrollPane.getUI()"""
        return 'ScrollPaneUI'.__wrap(super(JScrollPane, self).getUI())
    ...
    @override
    @overload
    def setWheelScrollingEnabled(self, arg0: bool):
        """public void javax.swing.JScrollPane.setWheelScrollingEnabled(boolean)"""
        super(__JScrollPane, self).setWheelScrollingEnabled(__boolean.valueOf(arg0))
    ...
    @override
    @overload
    def getHorizontalScrollBarPolicy(self) -> int:
        """public int javax.swing.JScrollPane.getHorizontalScrollBarPolicy()"""
        return int.__wrap(super(JScrollPane, self).getHorizontalScrollBarPolicy())
    ...
    @override
    @overload
    def setRowHeader(self, arg0: 'JViewport'):
        """public void javax.swing.JScrollPane.setRowHeader(javax.swing.JViewport)"""
        super(__JScrollPane, self).setRowHeader(arg0)
