...
class ParticleType():
    ...
    def getId(self) -> 'util.Identifier':
        ...
        return 'util.Identifier'.__wrap(super(ParticleType, self).getId())
    ...
    def getRawId(self) -> int:
        ...
        return int.__wrap(super(ParticleType, self).getRawId())
...
import dev.ultreon.quantum.world.particles.ParticleTypes as __ParticleTypes
__ParticleTypes = __ParticleTypes
from builtins import str
import java.lang.Long as __long
from pyquantum_helper import override
import java.lang.Class as __Class
...
class ParticleTypes():
    ...
    @staticmethod
    def __wrap(java_value: __ParticleTypes) -> 'ParticleTypes':
    ...
    #
    @overload
    def __init__(self, __dynamic__: __ParticleTypes):
        """
    ...
    ENTITY_SMOKE: 'ParticleType' = __wrap(__ParticleType.ENTITY_SMOKE)
